...
dataOrg <- read.csv("datasets/7_auto-mpgUse.csv")
...
# }
# save(distanceObs,file = "/distMats/distanceObs_data7.RData")
load("distMats/distanceObs_data7.RData")
