...
dataOrg <- read.csv("datasets/14_HouseTasksUse.csv")
...
dataOrg$Task <- as.integer(as.factor(dataOrg$Task))
dataOrg$Who <- as.integer(as.factor(dataOrg$Who))
...
# }
# save(distanceObs,file = "/distMats/distanceObs_data14.RData")
load("distMats/distanceObs_data14.RData")
