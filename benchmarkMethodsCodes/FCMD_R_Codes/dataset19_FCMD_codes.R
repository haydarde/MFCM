...
dataOrg <- read.csv("datasets/19_lalondeUse.csv")
...
dataOrg$race <- as.integer(as.factor(dataOrg$race))
...
# }
# save(distanceObs,file = "/distMats/distanceObs_data19.RData")
load("distMats/distanceObs_data19.RData")
